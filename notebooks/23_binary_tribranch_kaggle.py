...
class Config:
    ...
    OUTPUT_DIR = "outputs_gcmab_binary"
    ...
    for epoch in range(cfg.EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            if accelerator_obj.is_main_process:
                ...
                }, os.path.join(cfg.MODEL_DIR, "best_gcmab_binary.pt"))
...
best_path = os.path.join(cfg.MODEL_DIR, "best_gcmab_binary.pt")
...
if accelerator.is_main_process:
    ...
    zip_filename = "outputs_gcmab_binary"
