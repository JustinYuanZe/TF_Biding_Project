...
class Config:
    ...
    OUTPUT_DIR = "outputs_gcmab_tribranch"
...
print(f"Architecture: G-CMAB msCNN (Script 22)")
...
class TriBranchGCMABmsCNNClassifier(nn.Module):
    """
    Script 22: G-CMAB msCNN Classifier.
    ...
    def __init__(self, backbone, cfg):
        ...
        # Branch 3: Bio-Features (CpG, GC, G4)
...
class TriBranchDataset(Dataset):
    ...
    def _precompute_bio_features(self):
        """Precompute CpG O/E ratio, GC content, and G-Quadruplex presence."""
        features = []
...
model = TriBranchGCMABmsCNNClassifier(backbone=dnabert_model, cfg=cfg)
...
if accelerator.is_main_process:
    print(f"\n{'='*60}")
    print("MODEL SUMMARY -- G-CMAB msCNN (Script 22)")
    print(f"{'='*60}")
    ...
    for epoch in range(cfg.EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            if accelerator_obj.is_main_process:
                ...
                }, os.path.join(cfg.MODEL_DIR, "best_gcmab_tribranch.pt"))
...
best_path = os.path.join(cfg.MODEL_DIR, "best_gcmab_tribranch.pt")
...
if accelerator.is_main_process:
    print("\n" + "=" * 60)
    print("PIPELINE SUMMARY -- G-CMAB msCNN (Script 22)")
    print("=" * 60)
    ...
    print(f"  |  Script 22 (G-CMAB msCNN):   {max(history['val_acc']):.2%}                      |")
    print("  +-----------------------------------------------------------+")
    print("=" * 60)
...
if accelerator.is_main_process:
    ...
    zip_filename = "outputs_gcmab_tribranch"
