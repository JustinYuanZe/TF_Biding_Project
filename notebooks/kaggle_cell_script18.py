"""
KAGGLE CELL SCRIPT 18
Copy toàn bộ code dưới đây vào 1 cell Kaggle rồi chạy.
Script sẽ tự động pull repo mới nhất và chạy Script 18.
"""
...
subprocess.run(["python3", "notebooks/18_simplified_crossmodal_kaggle.py"], check=True)
