#!/usr/bin/env python3
"""
Auto-refactored script: 26_binary_gcmab_safe_kaggle.py
...
class Config:
    ...
    OUTPUT_DIR = "outputs_binary_gcmab_safe"
    ...
    for epoch in range(cfg.EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            if accelerator_obj.is_main_process:
                ...
                }, os.path.join(cfg.MODEL_DIR, "best_binary_gcmab_safe.pt"))
...
best_path = os.path.join(cfg.MODEL_DIR, "best_binary_gcmab_safe.pt")
...
if accelerator.is_main_process:
    ...
    zip_filename = "outputs_binary_gcmab_safe"
